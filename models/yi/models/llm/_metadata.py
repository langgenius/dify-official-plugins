"""Helpers for attaching Dify metadata to 01.AI requests as request headers.

01.AI's plugin extends ``dify_plugin.OAICompatLargeLanguageModel``,
...
Caveats:
- 01.AI's public API does not document these headers today, so the
  ...
  togetherai, moonshot, groq, xai, openrouter, sagemaker).
