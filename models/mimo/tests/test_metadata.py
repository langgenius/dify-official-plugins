"""Unit tests for the opt-in Dify metadata helper used by the Xiaomi MiMo plugin.
...
These tests do not need a network or the Xiaomi MiMo SDK: the helper is
pure and runs entirely in memory. The integration with `_invoke` and
...
def test_helper_is_imported_in_llm_py() -> None:
    """The helper is wired into MimoLargeLanguageModel."""
