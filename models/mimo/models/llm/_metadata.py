"""Helpers for attaching Dify metadata to Xiaomi MiMo requests as request headers.

Xiaomi MiMo's plugin extends ``dify_plugin.OAICompatLargeLanguageModel``,
...
Caveats:
- Xiaomi MiMo's public API does not document these headers today, so
