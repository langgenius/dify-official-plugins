"""Helpers for attaching Dify metadata to Upstage requests as request headers.

Upstage's plugin uses the official ``openai`` Python SDK
...
Caveats:
- Upstage's public API does not document these headers today, so the
