"""Helpers for attaching Dify metadata to 360 AI (zhinao) requests as request headers.

360 AI's plugin extends ``dify_plugin.OAICompatLargeLanguageModel``,
...
Caveats:
- 360 AI's public API does not document these headers today, so the
