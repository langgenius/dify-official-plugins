"""Helpers for attaching Dify metadata to xAI requests as request headers.

xAI's plugin extends ``dify_plugin.OAICompatLargeLanguageModel``,
...
Caveats:
- xAI's public API does not document these headers today, so the
