"""Helpers for attaching Dify metadata to SiliconFlow requests as request headers.

SiliconFlow's plugin extends ``dify_plugin.OAICompatLargeLanguageModel``,
...
Caveats:
- SiliconFlow's public API does not document these headers today, so
  ...
  mimo, longcat, zhinao, wenxin, lemonade).
