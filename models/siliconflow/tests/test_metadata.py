"""Unit tests for the opt-in Dify metadata helper used by the SiliconFlow plugin.
...
These tests do not need a network or the SiliconFlow SDK: the helper is pure
...
def test_helper_is_imported_in_llm_py() -> None:
    """The helper is wired into SiliconflowLargeLanguageModel."""
