"""Helpers for attaching Dify metadata to SambaCloud requests as request headers.

SambaCloud's plugin is a thin wrapper over
...
Caveats:
- SambaCloud does not document these headers today, so the value is
