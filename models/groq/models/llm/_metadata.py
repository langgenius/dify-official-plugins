"""Helpers for attaching Dify metadata to Groq requests as request headers.

Groq's plugin extends ``dify_plugin.OAICompatLargeLanguageModel``,
...
Caveats:
- Groq's public API does not document these headers today, so the
