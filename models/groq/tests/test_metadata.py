"""Unit tests for the opt-in Dify metadata helper used by the Groq plugin.
...
These tests do not need a network or the Groq SDK: the helper is pure
...
def test_helper_is_imported_in_llm_py() -> None:
    """The helper is wired into GroqLargeLanguageModel."""
