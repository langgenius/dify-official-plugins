"""Helpers for attaching Dify metadata to Huawei Cloud MAAS HK requests as request headers.

Huawei Cloud MAAS HK's plugin is a thin wrapper over
...
Caveats:
- Huawei Cloud MAAS HK does not document these headers today, so the
  value is purely for observability / proxy-side propagation,
  ...
  sagemaker, yi, mimo, longcat, zhinao, wenxin, lemonade,
  siliconflow, gpustack, baichuan, upstage, llama_api, replicate,
  hunyuan, oci, volcengine_maas, nvidia_nim, sambanova, x).
