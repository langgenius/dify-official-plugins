"""Helpers for attaching Dify metadata to NVIDIA NIM requests as request headers.

NVIDIA NIM's plugin is a thin wrapper over
...
Caveats:
- NVIDIA NIM does not document these headers today, so the value is
