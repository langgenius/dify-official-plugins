"""Helpers for attaching Dify metadata to Moonshot requests as request headers.

Moonshot's plugin extends ``dify_plugin.OAICompatLargeLanguageModel``,
...
Caveats:
- Moonshot's public API does not document these headers today, so the
