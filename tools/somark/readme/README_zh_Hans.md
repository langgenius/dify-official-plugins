...
3.  Configure the SoMark plugin parameters:
    ...
    *   **Base URL** (required / 必填): The address of the SoMark service.
        ...
        - For SoMark API, fill in `https://somark.cn/api/v1` (Mainland China) or `https://somark.ai/api/v1` (Taiwan, China; Hong Kong, China; Macau, China; and other overseas regions).
          ...
          使用 SoMark API 时，中国大陆填写 `https://somark.cn/api/v1`，中国台湾、中国香港、中国澳门及其他海外地区填写 `https://somark.ai/api/v1`。
    ...
    *   **API Key**:
        ...
        - *No API Key?* 免费领取 1000 页额度：[中国大陆](https://somark.cn/workbench/purchase) | [中国台湾、中国香港、中国澳门及其他海外地区](https://somark.ai/studio/purchase)
