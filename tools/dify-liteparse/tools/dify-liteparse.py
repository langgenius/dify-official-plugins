...
# Use Docling as the core engine
    ...
    def _invoke(self, tool_parameters: dict[str, Any]) -> Generator[ToolInvokeMessage]:
        ...
        try:
            ...
            try:
                ...
                yield self.create_text_message(f"Docling parsing failed: {str(e)}")
