...
class GetChannelTool(Tool):
    def _invoke(
        ...
        if tool_parameters.get("include_num_members"):
            params["include_num_members"] = "true"

        try:
            response = client.call("conversations.info", "GET", params=params)
        ...
        yield self.create_text_message(
            f"Channel '{info.get('name', channel)}' retrieved."
        )
