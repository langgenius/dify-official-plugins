...
<!-- logo -->
<p align="center">
  <img src="_assets/icon.svg" width="120px" style="vertical-align:middle;">
</p>
...
<p align="center">
    👋 join us on <a href="https://discord.gg/Jhgb2eKWh8" target="_blank">Discord</a>
</p>
...
<p align="center">
  ...
  <br/>
  <a href="https://github.com/DataEval/dingo/stargazers" target="_blank">Star Dingo on GitHub</a>
</p>
...
Architecture overview: https://github.com/DataEval/dingo
...
GUI output screenshot: https://github.com/DataEval/dingo#readme
...
📊 **[View Complete Metrics Documentation →](https://github.com/DataEval/dingo/blob/dev/docs/metrics.md)**
...
📖 **[View Hallucination Detection Guide →](https://github.com/DataEval/dingo/blob/dev/docs/hallucination_guide.md)**

### Factuality Assessment

For comprehensive guidance on using Dingo's two-stage factuality evaluation system:

📖 **[View Factuality Assessment Guide →](https://github.com/DataEval/dingo/blob/dev/docs/factcheck_guide.md)**
