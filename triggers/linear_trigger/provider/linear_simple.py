...
class LinearSubscriptionConstructor(TriggerSubscriptionConstructor):
    ...
    def _validate_api_key(self, credentials: Mapping[str, Any]) -> None:
        ...
        try:
            response = self._graphql_request(api_key, query)
    ...
    def _create_subscription(
        ...
        resource_types = parameters.get("resource_types", ["Issue"])
        ...
        try:
            response = self._graphql_request(api_token, mutation, variables)
    ...
    def _fetch_parameter_options(
        ...
        try:
            response = self._graphql_request(api_token, query)
