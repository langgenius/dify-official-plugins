...
| App               | Specify the Dify app that has been created & published in the Dify studio. | Set apps compatible with Chat Completion such as chat flows, chatbots, agents, and text generators. Chat flows are guaranteed.              |
...
The only supported endpoint is Chat Completions. Endpoints like /model and /responses are not supported.
...
App 1: http://localhost/e/c0odrljwgijfqlgl/chat/completions
App 2: http://localhost/e/a7tags9tjz4d4e4o/chat/completions
